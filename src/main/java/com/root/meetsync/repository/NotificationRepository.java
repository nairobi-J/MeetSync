...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    @Query("""
        ...
        JOIN Booking b ON n.relatedEntityId = b.id
        WHERE n.user = :user
          
          AND n.type = :type
          AND n.relatedEntityType = 'Booking'
          AND b.status = 'PENDING'
    """)
   
    Long countPendingUnaccepted(@Param("user") User user, @Param("type") Notification.NotificationType type);
